...
par(mfrow = c(2,2),mar=c(4,4,3,2),cex.lab = 0.8,cex.axis=0.8)
...
legend("topright",lty=c(1,1,1),col = c("black", "blue", "red"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),cex = 0.8,bty = "n")
